 ...
 *     uses array operations in the update function that evolves every 
 *     generation.
 */
...
void update_generation(int *cells, int num_cells)
{
    int *new_array, i, previous, current, next;
    ...
    /* Update the new array with the correct values depending on the adjacent 
     * cell values in the previous generation.
     */
